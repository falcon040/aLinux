...
downloadliste=(
 ...
 "ftp://ftp.gnupg.org/gcrypt/libassuan/libassuan-2.4.0.tar.bz2"
 ...
 "http://ftp.acc.umu.se/pub/gnome/sources/glib/2.46/glib-2.46.2.tar.xz"
 "ftp://ftp.gnome.org/pub/gnome/sources/libcroco/0.6/libcroco-0.6.9.tar.xz"
 ...
 "ftp://ftp.kernel.org/pub/software/scm/git/git-2.6.3.tar.xz"
 ...
 "http://ftp.osuosl.org/pub/blfs/conglomeration/unrarsrc/unrarsrc-5.3.7.tar.gz"
 ...
 "ftp://ftp.gnome.org/pub/gnome/sources/glib/2.46/glib-2.46.2.tar.xz"
 ...
 "ftp://ftp.osuosl.org/pub/midnightcommander/mc-4.8.15.tar.xz"
 ...
 "http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.3.1.tar.gz"
 ...
 "http://www.freedesktop.org/software/libevdev/libevdev-1.4.5.tar.xz"
...
downloadliste1=(
 ...
 "ftp://ftp.gnome.org/pub/gnome/sources/gdk-pixbuf/2.32/gdk-pixbuf-2.32.2.tar.xz"
 ...
 "https://www.bunkus.org/videotools/mkvtoolnix/sources/mkvtoolnix-8.5.2.tar.xz"
...
downloadliste1=(
 ...
 "http://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.6.1.tar.xz"
 "http://gstreamer.freedesktop.org/src/gst-plugins-base/gst-plugins-base-1.6.1.tar.xz"
 "http://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.6.1.tar.xz"
 "http://gstreamer.freedesktop.org/src/gst-plugins-bad/gst-plugins-bad-1.6.1.tar.xz"  
 "http://gstreamer.freedesktop.org/src/gst-libav/gst-libav-1.6.1.tar.xz"
 "https://ftp.mozilla.org/pub/mozilla.org/nspr/releases/v4.10.10/src/nspr-4.10.10.tar.gz"
 ################"http://www.linuxfromscratch.org/patches/blfs/systemd/nss-3.21-standalone-1.patch"
 "http://ftp.osuosl.org/pub/blfs/conglomeration/nss/nss-3.21.tar.gz" 
